...
import '../style/driverRegistratioin.css'
...
export default class Driverreg extends Component {
    ...
    saveDriver=(e)=>{
            e.preventDefault();
            let driver={dFirstName:this.state.dFirstName,
            ...
            driverService.registerDriver(driver).then(res=>{
                ...
                <div className="container">
                    <div className="row">
                        <div className="card col-md-6 offset-md-3 offset-md-3">
                            <h3 className="text-center">Driver register </h3>
                            <div className="card-body" id="dregi">
                                <form>
